...
function WhyKachiHealthSection() {
  return (
    <React.Fragment>
      ...
      >
        <div className="container mx-auto flex flex-wrap py-16">
          <div className="flex h-auto flex-wrap items-center justify-center p-4 md:p-8">
            ...
            >
              <h2 className="mb-5 text-4xl font-bold text-primary sm:mb-10 md:mb-[60px] md:text-5xl" data-aos="fade-up" data-aos-anchor-placement="bottom-center">
                Mastering the Clinical Guidelines
              </h2>
              <p className="text-base md:text-2xl" data-aos="fade-up" data-aos-anchor-placement="bottom-center" data-aos-delay="300">
      ...
      <div
        className="blockItem section py-6 md:py-14"
        data-anchor="why-kachi-health-content-3"
      >
        <div className="container mx-auto flex flex-wrap py-16">
          <div className="flex h-auto flex-wrap items-center justify-center p-4 md:p-8">
            <div
