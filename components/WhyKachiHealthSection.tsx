...
function WhyKachiHealthSection() {
  return (
    <div className="container mx-auto flex flex-wrap py-16">
      <div className="blockItem py-6 md:py-14">
        <p className="mx-auto mb-12 text-center text-2xl" data-aos="fade-up" data-aos-anchor-placement="center-center"
>
        ...
        <div className="flex flex-wrap h-auto items-center justify-center p-4 md:p-8">
          <div className="md:block" data-aos="fade-right" data-aos-delay="500" data-aos-anchor-placement="center-center">
            <Image
              src={Image01}
              width={557}
              height={372}
          ...
          <div className="md:ml-20 md:w-1/3" data-aos="fade-left" data-aos-delay="500" data-aos-anchor-placement="center-center">
      ...
      <div className="blockItem py-6 md:py-14">
        <div className="flex flex-wrap h-auto items-center justify-center p-4 md:p-8">
          <div className="md:w-1/3 order-2 md:order-1" data-aos="fade-right" data-aos-delay="500" data-aos-anchor-placement="center-center">
            <h2 className="mb-5 sm:mb-10 md:mb-[60px] text-4xl font-bold text-primary md:text-5xl">
          ...
          <div className="md:ml-20 md:block order-1 md:order-2" data-aos="fade-left" data-aos-delay="500" data-aos-anchor-placement="center-center">
            <Image
              src={Image02}
              width={557}
              height={372}
      ...
      <div className="blockItem py-6 md:py-14">
        <div className="flex flex-wrap h-auto items-center justify-center p-4 md:p-8">
          <div className="md:block order-2 md:order-1" data-aos="fade-right" data-aos-delay="500" data-aos-anchor-placement="center-center">
            <Image
              src={Image03}
              width={557}
              height={372}
          ...
          <div className="md:ml-20 md:w-1/3 order-1 md:order-2" data-aos="fade-left" data-aos-delay="500" data-aos-anchor-placement="center-center">
            <h2 className="mb-5 sm:mb-10 md:mb-[60px] text-4xl font-bold text-primary md:text-5xl">
